...
rewardUCB, actionUCB = k_bandit_testbed(10, 1000, 2000, [0], UCB = True)
rewardReal, actionReal = k_bandit_testbed(10, 1000, 2000, [0.1])


#plt.subplot(212)
plt.plot(rewardUCB[0], label = "UCB, $c=2$")
plt.plot(rewardReal[0], label = "$\epsilon$-Greedy, $\epsilon =0.1$")
plt.legend()
plt.xlabel('Steps')
